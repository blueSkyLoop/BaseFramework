...
// Private
@interface IDMPhotoBrowser () <IDMZoomingScrollViewDelegate> {
	// Data
...
#pragma mark - IDMZoomingScrollViewDelegate
...
//            page = [[IDMZoomingScrollView alloc] initWithPhotoBrowser:self];
            page = [[IDMZoomingScrollView alloc] initWithPhotoDelegate:self];
