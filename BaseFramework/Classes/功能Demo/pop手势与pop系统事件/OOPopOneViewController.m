...
@interface OOPopOneViewController ()

@end

@implementation OOPopOneViewController
...
- (void)showAction{
    OOPopTwoViewController *vc = [[OOPopTwoViewController alloc] init];
